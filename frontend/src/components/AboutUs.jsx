    ...
    <div className="min-h-svh bg-gray-800 text-white">
      ...
      <div className="p-8 flex flex-col items-center">
        <div className="max-w-3xl">
          ...
          <h2 className="text-2xl font-semibold mb-2 mt-12 text-center">
            App Development
          </h2>
          <p className="mb-4 text-balance">
          ...
          <ul className="list-disc list-inside mb-4">
            <li className="mb-2 text-balance">
              Frontend: React with Vite for an optimized development
              environment, Zustand for state management, and Tailwind
              CSS/DaisyUI for an appealing UI design.
            </li>
            <li className="mb-2 text-balance">
          ...
          <ul className="list-disc list-inside mb-4">
            <li className="mb-2 text-balance">
              Our application allows users to register, log in, and communicate
            ...
            <li className="mb-2 text-balance">
              Modern user interface, optimized for both desktop and mobile
              devices
            </li>
          </ul>
          <h2 className="text-2xl font-semibold mb-2 mt-12 text-center">
          ...
          <ul className="list-disc list-inside mb-4">
            <li className="mb-2  w-80">
              <span className="inline-block w-40">Live Demo – Olivia:</span>
              <a
            ...
            <li className="mb-2 w-80">
              <span className="inline-block w-40">Live Demo – Renat:</span>
              <a
            ...
            <li className="mb-2 w-80">
              <span className="inline-block w-40">Source Code:</span>
              <a
          ...
          <h3 className="my-12 text-xl text-center text-balance">
            We appreciate feedback and suggestions and warmly invite developers
            to contribute to the further development of the app!
          </h3>
        </div>
      </div>
    </div>
